...
// Extraído de MentionCollectionList.vue para no duplicar el
...
<template>
  <v-sheet v-if="description" class="d-flex align-center" color="transparent">
    <v-icon :color="color" class="ml-2">help_outline</v-icon>
    <v-tooltip
      activator="parent"
