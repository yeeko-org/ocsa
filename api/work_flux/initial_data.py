    ...
    def __init__(self):
        init_status = [
            ...
            ("rejected", "validation", "Rechazado",
                "red", "bug_report", False, True, False, 10),
            ("validated", "validation", "Aprobado",
                "green", "verified", True, True, False, 14),
            ("need_reclassify", "validation", "Requiere re-clasificarse",
                "orange", "gpp_bad", True, True, False, 4),
